...
public class Balance {
    ...
    public double getBtcusd_fee() {
        return btcusd_fee;
    }

    public void setBtcusd_fee(double btcusd_fee) {
        this.btcusd_fee = btcusd_fee;
    }
    ...
    public double getEurusd_fee() {
        return eurusd_fee;
    }

    public void setEurusd_fee(double eurusd_fee) {
        this.eurusd_fee = eurusd_fee;
    }
    ...
    public double getLtcbtc_fee() {
        return ltcbtc_fee;
    }

    public void setLtcbtc_fee(double ltcbtc_fee) {
        this.ltcbtc_fee = ltcbtc_fee;
    }
    ...
    public double getLtcusd_fee() {
        return ltcusd_fee;
    }

    public void setLtcusd_fee(double ltcusd_fee) {
        this.ltcusd_fee = ltcusd_fee;
    }
    ...
    public double getXrpbtc_fee() {
        return xrpbtc_fee;
    }

    public void setXrpbtc_fee(double xrpbtc_fee) {
        this.xrpbtc_fee = xrpbtc_fee;
    }
