...
//        logger.info("test : " + httpServletRequest.getLocalPort());
        ...
        if (httpServletRequest.getServletPath().equals("/")) {
            ...
            if (httpServletRequest.getServletPath().equals("/signup")) {
                ...
                return true;
            } else if (httpServletRequest.getServletPath().equals("/money")) {
                logger.debug("in else servletPath  in if servletPath equals /money.");
                return true;
            } else if (httpServletRequest.getServletPath().equals("/money2")) {
                logger.debug("in else servletPath  in if servletPath equals /money2.");
                return true;
            } else if (httpServletRequest.getServletPath().equals("/money3")) {
                logger.debug("in else servletPath  in if servletPath equals /money3.");
                return true;
